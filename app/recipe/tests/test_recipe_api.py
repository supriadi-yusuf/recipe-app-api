...
def create_recipe(user, **params):
    ...
    # update data in dict default
    # with data from dict params
...
class PublicRecipeAPITests(TestCase):
    ...
    def test_auth_required(self):
        ...
        result = self.client.get(RECIPES_URLS)
...
class PrivateRecipeAPITest(TestCase):
    ...
    def test_retrieve_recipes(self):
        ...
        # many=True means list of items not single item
    ...
    def test_create_recipe(self):
        ...
        result = self.client.post(RECIPES_URLS, payload)
        recipe = Recipe.objects.get(id=result.data['id'])

        # payload.items() return list of tuples
        # the tuple contains pair of key - value
    ...
    def test_create_recipe_with_new_tags(self):
        ...
        # we have to mention the format because data is nested
        # (there is dictionary inside dictionary)
        result = self.client.post(RECIPES_URLS, payload, format='json')
    ...
    def test_update_recipe_assign_ingredient(self):
        """Test assinging an existing ingredient when updating recipe."""
    ...
    def test_filter_by_tags(self):
        ...
        result = self.client.get(RECIPES_URLS, params)
